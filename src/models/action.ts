...
export class SerializableAction {
  ...
  static fromInstruction(instruction: TransactionInstruction): SerializableAction {
    ...
    serAction.actionCode = openInstruction.code ? openInstruction.code : CUSTOM_ACTION_CODE;
