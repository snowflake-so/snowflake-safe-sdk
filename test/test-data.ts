...
export const testWallet = Keypair.fromSecretKey(
  new Uint8Array([
    63, 231, 113, 72, 156, 227, 201, 211, 118, 236, 133, 156, 39, 245, 184, 242, 30, 208, 133, 197,
    169, 203, 29, 155, 243, 93, 12, 61, 42, 0, 116, 168, 219, 81, 127, 74, 74, 245, 57, 177, 185, 9,
    113, 42, 160, 227, 48, 156, 42, 207, 225, 149, 26, 238, 195, 47, 100, 52, 243, 4, 26, 194, 173,
    199,
  ])
);
...
export const testSafe = new PublicKey('3M8DzUFD6os5uSyu7f8Gf9DdGQke7YPvQU7obBcXgQ35');
